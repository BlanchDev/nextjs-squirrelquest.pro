...
export async function GET(request) {
  try {
    ...
    if (!isValidSession) {
      ...
      const isLimited = await isRateLimited(ip, "admin_contacts_unauthorized");
      if (isLimited) {
        return NextResponse.json(
          {
            success: false,
      ...
      await logRequest(ip, "admin_contacts_unauthorized");
    ...
    // await logRequest(ip, "admin_contacts_view");
